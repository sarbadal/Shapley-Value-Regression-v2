...
pth regressor does not appear. Further, let 

<img style="margin:0px 10px -5px 10px" src="https://render.githubusercontent.com/render/math?math=$R^2(p, r)$" width="" height=""> 

be the <img src="https://render.githubusercontent.com/render/math?math=$R^2$" width="" height=""> 

obtained by regression of y on X(p,r) and 

<img style="margin:0px 10px -5px 10px" src="https://render.githubusercontent.com/render/math?math=$R^2(q, r)$" width="" height=""> be the <img src="https://render.githubusercontent.com/render/math?math=R^2" width="" height=""> obtained by regression of y on X(q, r). Then, the share of the regressor
