...
total value of the game = <img src="https://latex.codecogs.com/svg.latex?\Small&space;\text{or the
total value of the game =}R^2=\sum_{p=1}^{m}S(p)=\sum_{p=1}^{m}(1/m)\sum_{r=1}^{k}\left\{\sum_{c=1}^{k}[R^2(p,r)-R^2(q,r-1)]\right\}/k" />
