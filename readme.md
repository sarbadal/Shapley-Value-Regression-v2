...
Let there be m number of regressor variables in the model <img src="https://render.githubusercontent.com/render/math?math=y = X\beta \plus u">. Let <img src="https://render.githubusercontent.com/render/math?math=X(p, r)"> be the r-membered subset
...
out. The sum of all <img src="https://render.githubusercontent.com/render/math?math=S(p)"> for p=1, m (that is, <img src="https://render.githubusercontent.com/render/math?math=\sum_{p=1}^{m}(p)">  is the <img src="https://render.githubusercontent.com/render/math?math=R^2"> of <img src="https://render.githubusercontent.com/render/math?math=y = X\beta \p u"> : (all <img src="https://render.githubusercontent.com/render/math?math=x_j \in X">) or the
